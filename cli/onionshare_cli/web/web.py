...
from .screencast_mode import ScreencastModeWeb
...
class Web:
    ...
    def __init__(self, common, is_gui, mode_settings, mode="share"):
        ...
        if self.mode == "share":
            ...
            self.screencast_mode = ScreencastModeWeb(self.common, self)
